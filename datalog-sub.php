...
<link rel="stylesheet" type="text/css" href="css/DataPageSub.css" />
<title>猫猫历史记录</title>
</head>
<body>
	<div class="main" id="sub-div">
		<div id="backToHome" class="mybutton" onclick="backToHome()">
			<div id="backIcon">
				<svg viewBox="0 0 20 20" width="30px" height="30px">
					<path d="M 18 0 L 0 9 L 18 18 z" fill="black"/>
				</svg>
			</div>
			<div class="btntext" id="backText">回到主页</div>
		</div>
